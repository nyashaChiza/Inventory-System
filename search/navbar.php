  <nav class="navbar navbar-expand-lg navbar-light bg-white  rounded">
        ...
        <div class="collapse navbar-collapse" id="navbarsExample09">
		  ...
		  <form action = "search.php" method = "post"  class="form-inline my-2 my-md-0">
			 <span class="pull-left"><a href="" data-toggle="modal" class="btn btn-primary"> Add New</a></span>  
	&nbsp
		<button type="submit" class="btn btn-primary">Search</button>
          ...
          &nbsp
		   <input type="text" Name = "search" class="form-control col-md-4  border  " placeholder="Type here" aria-label="Search" aria-describedby="button-addon1"> 
